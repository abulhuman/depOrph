/*
  ...
  - The values [createAccount] on the enum `accountMaintainenceType_enum` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "accountMaintainenceType_enum_new" AS ENUM ('register', 'passwordRecovery');
...
ALTER TABLE "accountMaintainence" ALTER COLUMN "type" SET DEFAULT 'register';
COMMIT;

-- AlterTable
ALTER TABLE "accountMaintainence" ALTER COLUMN "type" SET DEFAULT E'register';
