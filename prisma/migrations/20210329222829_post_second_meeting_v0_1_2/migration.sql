/*
  ...
  - You are about to drop the column `moblieNumber` on the `guardian` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "guardian" DROP COLUMN "moblieNumber",
