/*
  ...
  - The migration will remove the values [Coordiantor] on the enum `userRoles_enum`. If these variants are still used in the database, the migration will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "userRoles_enum_new" AS ENUM ('Admin', 'Head', 'Coordinator', 'Donor', 'SocailWorker', 'Guest');
